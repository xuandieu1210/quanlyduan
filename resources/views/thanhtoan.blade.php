...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-8 col-md-offset-1">
        ...
        <form class="form-horizontal" method="post" action="{{ route('thanhtoan.store') }}">
            @csrf
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">          
              <input type="text" class="form-control" name="ghichu" id="ngayhopdong" placeholder="Ghi chú">
            </div>
                       ...
                       <table id="list" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td id= "{{$row->id}}"> {{$row->ngay}}</td>
                              <td id= "{{$row->id}}"> {{$row->ghichu}}</td>
                            </tr>
                           @endforeach
                          </tbody>
